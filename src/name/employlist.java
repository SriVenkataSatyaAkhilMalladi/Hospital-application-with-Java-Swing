...
public class employlist {
    ...
    private ArrayList<employ> employeelist;
    
    public employlist(){
        this.employeelist = new ArrayList<employ>();
    }

    public ArrayList<employ> getEmployeelist() {
        return employeelist;
    }
    ...
    public void setPos_title(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setTeam_into(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
